            ...
            <nav class="relative container mx-auto p-6 font-sans drop-shadow-xl">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex space-x-6  text-bold">
                        <button><Link to="/blogposts" class="hover:bg-pink bg-blue py-2 px-4 rounded-r-4xl rounded-l-4xl">Blog Posts</Link></button>
                        <button><Link to="/userprofile" class="hover:text-pink bg-blue py-2 px-4 rounded-r-4xl rounded-l-4xl"> Your Profile </Link></button>
                        <Link to="/writeforus" class="hover:bg-pink bg-blue py-2 px-4 rounded-r-4xl rounded-l-4xl">Write for Us</Link>
